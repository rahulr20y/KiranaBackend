...
class Shopkeeper(models.Model):
    ...
    employees_count = models.IntegerField(default=1, blank=True, null=True)
    monthly_budget = models.DecimalField(max_digits=12, decimal_places=2, default=0, blank=True, null=True)
